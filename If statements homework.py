...
car = ['subaru' ,'lambo' ,'benz' ,'bmw' ,'dodge']
...
alien_colours = ['green']
for x in alien_colours:
    if x == 'green': print('You got 5 points')
    else: print('sorry no points')
    alien_colours = ['gold']
for x in alien_colours:
    if x == 'green': print('You got 5 points')
    else: print('sorry no points')
...
# Otherwise, print a generic greeting such as Hellow Jaden, thank you for logging in again.
...
# Loop through the new_users list to see if each new username has already been used. If it has, print a message that the person will need to enter a username. If a username has not been used, print a message saying that the username is available.
# Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted. (To do this, you'll need to make a copy of current_users containing the lowercase versions of all existing users.)

# 5-11. Ordinal Numbers: Ordinal numbers indicate their positions in a list, such as 1st or 2nd. Most ordinal numbers end in th, except 1,2 and 3.
